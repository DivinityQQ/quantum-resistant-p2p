...
def oqs_python_version() -> str:
    """liboqs-python version string."""
    # Since we're using a vendored version, return a fixed version
    # This avoids the warning about installing via pip
    return "vendored-12.0.0"  # Use whatever version you're vendoring
